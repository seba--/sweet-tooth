...
class AnalyzeListTest extends AnalyzeListSuite with Config {
  ...
  val map_top = dom.liftApp('_Nil) || dom.liftApp('_Cons, dom.liftApp('Zero), dom.top)
  val conc_top = dom.mliftApp('_Cons, dom.top, dom.top)
  val conc_toptop = dom.mliftApp('_Cons, dom.top, dom.top)
  ...
  val conc_topBaztop_FooBar = dom.liftApp('_Cons, dom.top, dom.liftApp('_Cons, dom.liftApp('Baz), dom.liftApp('_Cons, dom.mliftApp('Foo), dom.mliftApp('_Cons, dom.liftApp('Bar), dom.liftApp('_Nil)))))
  val atend_top_FooBar = dom.liftApp('_Cons, dom.liftApp('Foo), dom.liftApp('_Cons, dom.liftApp('Bar), dom.liftApp('_Nil))) || dom.liftApp('_Cons, dom.top, dom.top)
  val atend_top_FooBarBaz = dom.liftApp('_Cons, dom.liftApp('Foo), dom.liftApp('_Cons, dom.liftApp('Bar), dom.liftApp('_Cons, dom.liftApp('Baz), dom.liftApp('_Nil)))) || dom.liftApp('_Cons, dom.top, dom.top)
  val isempty_conc_top = dom.mliftApp('_Cons, dom.top, dom.top)
  val isempty_conc_toptop = dom.mliftApp('_Cons, dom.top, dom.top)
